...
(start code)
    $ heratool
    heratool> ls /files/etc/carbon/carbon.conf/
    cache/ = (none)
    relay/ = (none)
    aggregator/ = (none)

    heratool> get /files/etc/carbon/carbon.conf/cache/ENABLE_UDP_LISTENER
    /files/etc/carbon/carbon.conf/cache/ENABLE_UDP_LISTENER = False

    heratool> set /files/etc/carbon/carbon.conf/cache/ENABLE_UDP_LISTENER True
    heratool> save
    Saved 1 file(s)
(end code)
