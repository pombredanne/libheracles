...
About: Reference
  http://heracles.net/page/Create_a_lens_from_bottom_to_top
...
About: Lens Usage
  ...
  to use heratool -r option to point to 'debian' directory.
...
(* lens must be used with HERA_ROOT set to debian package source directory *)
