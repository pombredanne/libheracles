...
About: Usage Example
(start code)
heratool> set /heracles/load/Redis/incl "/etc/redis/redis.conf"
heratool> set /heracles/load/Redis/lens "Redis.lns"
heratool> load

heratool> get /files/etc/redis/redis.conf/vm-enabled
/files/etc/redis/redis.conf/vm-enabled = no
heratool> print /files/etc/redis/redis.conf/rename-command[1]/
...
heratool> set /files/etc/redis/redis.conf/activerehashing no
heratool> save
Saved 1 file(s)
heratool> set /files/etc/redis/redis.conf/save[1]/seconds 123
heratool> set /files/etc/redis/redis.conf/save[1]/keys 456
heratool> save
Saved 1 file(s)
(end code)
