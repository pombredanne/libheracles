...
(start code)
    ...
    heratool> ls /files/etc/exports/dir[1]
    client[1]/ = master
    client[2]/ = trusty
(end code)
...
(start code)
    heratool> ls /files/etc/exports/dir[1]/client[1]
    option = rw
...
(start code)
    heratool> set /files/etc/exports/dir[10000] /foo
    heratool> set /files/etc/exports/dir[last()]/client[1] weeble
    heratool> set /files/etc/exports/dir[last()]/client[1]/option[1] ro
    heratool> set /files/etc/exports/dir[last()]/client[1]/option[2] all_squash
    heratool> save
    Saved 1 file(s)
(end code)
