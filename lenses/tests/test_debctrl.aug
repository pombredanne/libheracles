...
let heracles_control = "Source: heracles
Priority: optional
...
Section: libs
Homepage: http://heracles.net/
DM-Upload-Allowed: yes

Package: heracles-tools
Section: admin
Architecture: any
...
Description: Augeas command line tools
 ...
 .
 This package provides command line tools based on libheracles0:
 - heratool, a tool to manage configuration files.
 - heraparse, a testing and debugging tool for heracles lenses.

Package: libheracles-dev
Section: libdevel
Architecture: any
Depends: libheracles0 (= ${binary:Version}), ${shlibs:Depends}, ${misc:Depends}
Description: Development files for writing applications based on libheracles0
 Augeas is a configuration editing tool. It parses configuration files in their
 native formats and transforms them into a tree. Configuration changes are made
 by manipulating this tree and saving it back into native config files.
 .
 ...
 API.
"
test DebCtrl.lns get heracles_control =
  { "srcpkg"
    { "Source" = "heracles" }
    { "Priority" = "optional" }
    { "Maintainer" = "Nicolas Valcárcel Scerpella (Canonical) <nicolas.valcarcel@canonical.com>" }
  ...
  { "binpkg"
    ...
    { "Description"
      ...
      { "text" = "." }
      { "text" = "This package provides command line tools based on libheracles0:" }
      { "text" = "- heratool, a tool to manage configuration files." }
      { "text" = "- heraparse, a testing and debugging tool for heracles lenses." }
    }
  }
  { "binpkg"
    { "Package" = "libheracles-dev" }
    ...
    { "Description"
      { "summary" = "Development files for writing applications based on libheracles0" }
      { "text" = "Augeas is a configuration editing tool. It parses configuration files in their" }
      { "text" = "native formats and transforms them into a tree. Configuration changes are made" }
      { "text" = "by manipulating this tree and saving it back into native config files." }
      { "text" = "." }
